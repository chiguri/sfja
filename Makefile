...
# coq_makefile -o Makefile.new Auto.v Basics.v Equiv.v Extraction.v Hoare2.v HoareAsLogic.v Hoare.v ImpCEvalFun.v ImpParser.v Imp.v Induction.v LibTactics.v Lists.v Logic.v MoreCoq.v MoreInd.v MoreLogic.v MoreStlc.v Norm.v PE.v Poly.v Postscript.v Preface.v ProofObjects.v Prop.v RecordSub.v Records.v References.v Rel.v SfLib.v Smallstep.v StlcProp.v Stlc.v Sub.v Symbols.v Typechecking.v Types.v UseAuto.v UseTactics.v 
#
...
html: $(GLOBFILES) $(VFILES)
	...
	cp deps.html deps.gif jquery.maphilight.min.js html
	tar zcvf html/sfja.tar.gz *.v *.css *.js *.html Makefile README LICENSE *.gif
...
clean:
	...
	rm -f imp.ml imp.mli imp1.ml imp1.mli imp2.ml imp2.mli
	- rm -rf html mlihtml
