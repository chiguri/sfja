...
[[
    ...
    は [eqb_string V V'] が[true]か[false]かで場合分けする推論をすることを意味します。
...
[[
    ...
    （[st =[ c1 ]=> c1' / st'] のように書くことで [Imp] での表記法により近くなりますので、そうした方がいいかもしれません。） *)
...
(* end hide *)
(** 部分評価について代入よりトリッキーなのは条件分岐 [TEST b1 THEN c1 ELSE c2 FI] です。
